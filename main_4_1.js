(function run() { //самозапускающаяся 
    ...
    function getRndNumber() {
        return Math.floor((Math.random() * 6) + 1); // ф-ция рандомных чисел
    }
    ...
    (totalSum > 100) ? setResult("Победа Вы набрали : " + totalSum + " point"): setResult("Вы Проиграли.Вы Набрали : " + totalSum + " point")
